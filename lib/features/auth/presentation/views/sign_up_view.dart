...
import 'package:delivery_courier_app/features/auth/presentation/views/widgets/sign_up_view_body_bloc_consumer.dart';
...
class SignUpView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(body: const SignUpViewBodyBlocConsumer()),
    );
  }
}
